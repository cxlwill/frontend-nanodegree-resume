...
var HTMLwechat = '<li class="flex-item"><span class="blue-text">Wechat</span><span class="white-text">%data%</span></li>';
...
var HTMLskillsStart = '<h3 id="skills-h3">Skills at a Glance:</h3><div class="skill-container"><ul id="skills" class="flex-column"></ul><svg class="chart flex-column"></svg></div>';
var HTMLskills = '<li class="flex-item" id="skill-item"><span class="white-text">%data%</span></li>';
...
var HTMLacademicEducation = '<h3 id="onlineClass-h3">Academic Education</h3>';
